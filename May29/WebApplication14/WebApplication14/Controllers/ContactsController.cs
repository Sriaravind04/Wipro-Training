...
namespace WebApplication14.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(WebApplication14Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("name,email,phone,message")] Contact contact)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["success Message"] = "Contact submitted sucessfully";
        ...
        public async Task<IActionResult> Edit(string id, [Bind("name,email,phone,message")] Contact contact)
        {
            if (id != contact.name)
            {
                return NotFound();
